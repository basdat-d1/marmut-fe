    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 p-6">
      ...
      {royaltyData && (
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">Total Royalty</CardTitle>
            ...
            <CardContent>
              {royaltyData.songs.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-600">You don't have any royalty earnings yet.</p>
                </div>
              ) : (
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b">
                        <th className="text-left py-3 px-4 font-medium text-gray-900">Song</th>
                        <th className="text-right py-3 px-4 font-medium text-gray-900">Plays</th>
                        <th className="text-right py-3 px-4 font-medium text-gray-900">Downloads</th>
                        <th className="text-right py-3 px-4 font-medium text-gray-900">Play Royalty</th>
                        <th className="text-right py-3 px-4 font-medium text-gray-900">Download Royalty</th>
                        <th className="text-right py-3 px-4 font-medium text-gray-900">Total Royalty</th>
                      </tr>
                    </thead>
                    <tbody>
                      {royaltyData.songs.map((song) => (
                        <tr key={song.id_konten} className="border-b hover:bg-gray-50">
                          <td className="py-3 px-4">
                            <div>
                              <p className="font-medium text-gray-900">{song.judul}</p>
                            </div>
                          </td>
          ...
          <Card className="mt-6">
            <CardHeader>
              <CardTitle>Royalty Information</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h4 className="font-medium text-gray-900 mb-2">How Royalties Work</h4>
