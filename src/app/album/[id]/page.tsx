...
export default function AlbumDetailPage() {
  ...
  const handleAddSong = () => {
    // Navigate to add song page or open modal
    router.push(`/album/${albumId}/add-song`)
  }
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            ...
            <Button className="btn-spotify" onClick={handleAddSong}>
            ...
            {songs.length === 0 ? (
              <div className="text-center py-16">
                ...
                <p className="text-gray-400 mb-6 max-w-md mx-auto">
                  This album doesn't have any songs yet. Add your first song to get started.
                </p>
                <Button onClick={handleAddSong} className="btn-spotify px-8 py-3 text-lg">
